...
In this project it is necessary to include a folder named data in src folder wich  includes a file named `.env.json`. This file contains a object with key: value. 
