    ...
    return (
      <div className="team__container">
        ...
        <div className="main__container-team">
          ...
          <div className="dashborad people__container-asana"><p className="asana-title">Asana killer</p><p className="killer-name">Emilio de la Torre</p><p className="killer-record">145</p><p className="killer-detail">Tareas completadas esta semana</p></div>
          <div className="dashborad people__container-git"><p className="git-title">Git killer</p><p className="killer-name">Ruben Sarrió</p><p className="killer-record">305</p><p className="killer-detail">Commits esta semana</p></div>
        </div>
        <Footer />
      </div>
    );
